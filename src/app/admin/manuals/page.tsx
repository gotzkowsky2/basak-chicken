                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      >
                        ...
                        <span className="sm:inline hidden">기존</span>
                        <span className="sm:hidden inline">기존</span>
                      </button>
                      <button
                        type="button"
                        onClick={() => setShowNewPrecautionModal(true)}
                        className="flex items-center space-x-1 px-2 py-1 text-xs sm:text-sm bg-orange-600 text-white rounded-md hover:bg-orange-700 transition"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                        </svg>
                        <span className="sm:inline hidden">새 주의사항</span>
